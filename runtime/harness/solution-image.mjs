...
</style></head><body><main class="slide"><header><div class="eyebrow">TEACHBUDDY / 解题步骤</div><h1>${plain(value.title)}</h1></header><div class="steps">${steps}</div><div class="conclusion"><strong>结论&nbsp; </strong>${plain(value.conclusion)}</div><footer class="footer"><span>AI 辅助整理 · 请教师核对题意与结论</span><span>16:9 · 解题过程图</span></footer></main></body></html>`;
}
