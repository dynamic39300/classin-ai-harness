...
export function StudentClassAnnouncementPage() {
  ...
  return <ClassAnnouncementWorkspace role="student-family" classId={classId} announcementId={announcementId} source={source} />;
}
