...
export function RichTextContent({ children, className, mentionLabels }: RichTextContentProps) {
  ...
  return (
    <div className={[styles.response, className].filter(Boolean).join(' ')} data-rich-text-content="true">
